...
design_libs=(xpm lib_cdc_v1_0_2 lib_pkg_v1_0_2 fifo_generator_v13_2_8 lib_fifo_v1_0_17 blk_mem_gen_v8_4_6 lib_bmg_v1_0_15 lib_srl_fifo_v1_0_2 axi_datamover_v5_1_30 axi_vdma_v6_3_16 xil_defaultlib)
...
compile()
{
  ...
  vlogan -work blk_mem_gen_v8_4_6 $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"../../../ipstatic/hdl" \
  ...
  vlogan -work axi_vdma_v6_3_16 $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"../../../ipstatic/hdl" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/hsjang0918/Desktop/2022_dsd_final_project-nexys/build/layer_tb/fc_tb_test/fc_tb.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key axi_vdma_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axi_vdma_0_simv.daidir vcs_lib c.obj)
