...
#
# Script generated by Vivado on Wed Nov 08 23:41:48 KST 2023
...
#
# Usage        : axi_vdma_0.sh
#                axi_vdma_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi_vdma_0.sh [-reset_run]
#                axi_vdma_0.sh [-reset_log]
#                axi_vdma_0.sh [-help]
#
...
#                script (type 'axi_vdma_0.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname lib_cdc_v1_0_2 -libname lib_pkg_v1_0_2 -libname fifo_generator_v13_2_8 -libname lib_fifo_v1_0_17 -libname blk_mem_gen_v8_4_6 -libname lib_bmg_v1_0_15 -libname lib_srl_fifo_v1_0_2 -libname axi_datamover_v5_1_30 -libname axi_vdma_v6_3_16 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm lib_cdc_v1_0_2 lib_pkg_v1_0_2 fifo_generator_v13_2_8 lib_fifo_v1_0_17 blk_mem_gen_v8_4_6 lib_bmg_v1_0_15 lib_srl_fifo_v1_0_2 axi_datamover_v5_1_30 axi_vdma_v6_3_16 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "axi_vdma_0.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi_vdma_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work blk_mem_gen_v8_4_6 $xmvlog_opts +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"../../../ipstatic/hdl" \
  ...
  xmvlog -work axi_vdma_v6_3_16 $xmvlog_opts +incdir+"$ref_dir/../../../ipstatic/hdl" +incdir+"../../../ipstatic/hdl" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axi_vdma_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axi_vdma_0 -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/hsjang0918/Desktop/2022_dsd_final_project-nexys/build/layer_tb/fc_tb_test/fc_tb.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axi_vdma_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: axi_vdma_0.sh [-step]\n\
Usage: axi_vdma_0.sh [-lib_map_path]\n\
Usage: axi_vdma_0.sh [-reset_run]\n\
Usage: axi_vdma_0.sh [-reset_log]\n\
Usage: axi_vdma_0.sh [-keep_index]\n\
