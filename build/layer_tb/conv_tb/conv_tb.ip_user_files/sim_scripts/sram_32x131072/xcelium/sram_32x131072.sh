...
#
# Script generated by Vivado on Thu Nov 09 00:16:01 KST 2023
...
#
# Usage        : sram_32x131072.sh
#                sram_32x131072.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                sram_32x131072.sh [-reset_run]
#                sram_32x131072.sh [-reset_log]
#                sram_32x131072.sh [-help]
#
...
#                script (type 'sram_32x131072.sh -help' for more information).
#
...
# script info
echo -e "sram_32x131072.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./sram_32x131072.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.sram_32x131072 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.sram_32x131072 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log sram_32x131072_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: sram_32x131072.sh [-step]\n\
Usage: sram_32x131072.sh [-lib_map_path]\n\
Usage: sram_32x131072.sh [-reset_run]\n\
Usage: sram_32x131072.sh [-reset_log]\n\
Usage: sram_32x131072.sh [-keep_index]\n\
