...
vlog -work xpm  -incr -mfcu  -sv "+incdir+../../../../../../src/tb/conv/ip/axi_vdma_0/hdl" \
...
vlog -work fifo_generator_v13_2_11  -incr -mfcu  "+incdir+../../../../../../src/tb/conv/ip/axi_vdma_0/hdl" \
...
vlog -work blk_mem_gen_v8_4_9  -incr -mfcu  "+incdir+../../../../../../src/tb/conv/ip/axi_vdma_0/hdl" \
...
vlog -work axi_vdma_v6_3_21  -incr -mfcu  "+incdir+../../../../../../src/tb/conv/ip/axi_vdma_0/hdl" \
...
vlog -work xil_defaultlib  -incr -mfcu  "+incdir+../../../../../../src/tb/conv/ip/axi_vdma_0/hdl" \
"../../../conv_tb.gen/sources_1/ip/sram_32x131072/sim/sram_32x131072.v" \

vlog -work axi_interconnect_v1_7_24  -incr -mfcu  "+incdir+../../../../../../src/tb/conv/ip/axi_vdma_0/hdl" \
